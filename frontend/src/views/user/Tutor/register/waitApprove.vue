<template>
  <div id="app">
      <div class="fw-bold text-center my-4">
        <div class="my-2" :class="center" :style="{fontSize: '2vw',}">อยู่ระหว่างการตรวจสอบ</div>
        <div class="step-container">
          ...
          <router-link to="/tutor/teaching/info" :class="center" style="text-decoration: none;">
            <div class="step actived"> 3 </div>
          </router-link>
  ...
  initInfo() {
      ...
      axios.post("http://localhost:3000/tutor/teacher/info", data)
        ...
        .then((res) => {
            ...
            this.profile_status = res.data.tutor.profile_status
